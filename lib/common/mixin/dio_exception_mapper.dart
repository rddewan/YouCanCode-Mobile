  ...
  Failure mapDioExceptionToFailure(DioException e, StackTrace stackTrace) {
    switch (e.type) {
      case DioExceptionType.connectionTimeout:
        return Failure(
          message: "Connection timeout with API server. Please try again later".hardcoded, 
          exception: e, 
          stackTrace: stackTrace,
        );
      case DioExceptionType.sendTimeout:
        return Failure(
          message: "Send timeout with API server. Check your internet connection and try again".hardcoded, 
          exception: e, 
          stackTrace: stackTrace,
        );
      case DioExceptionType.receiveTimeout:
        return Failure(
          message: "Receive timeout with API server. Check your internet connection and try again".hardcoded, 
          exception: e, 
          stackTrace: stackTrace,
        );
      case DioExceptionType.badCertificate:
        return Failure(
          message: "Bad certificate with API server. Please try again later".hardcoded, 
          exception: e, 
          stackTrace: stackTrace,
        );
      ...
      case DioExceptionType.connectionError:
        return Failure(
          message: "Connection error with API server. Please try again later".hardcoded, 
          exception: e, 
          stackTrace: stackTrace,
        );
